...
// Android: versionName 2.1.16 (versionCode 36)
// iOS: MARKETING_VERSION 2.1.16 (build 48)
const CURRENT_VERSION_NAME = '2.1.20';
const CURRENT_ANDROID_VERSION_CODE = 53;                                                                                                                                                   
const CURRENT_IOS_BUILD = 53;
